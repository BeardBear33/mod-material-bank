// modules/mod-material-bank/src/autoupdate.cpp
...
static std::unordered_set<std::string> LoadApplied(std::string const& moduleName)
{
    ...
    if (QueryResult r = WorldDatabase.Query(
            "SELECT `filename` FROM `customs`.`gv_updates` WHERE `module` = '{}'", moduleName))
...
// ---------- WorldScript ----------
class MB_Customs_UpdaterWS : public WorldScript
{
public:
    MB_Customs_UpdaterWS()
        : WorldScript("MB_Customs_UpdaterWS", std::vector<uint16>{ WORLDHOOK_ON_AFTER_CONFIG_LOAD, WORLDHOOK_ON_STARTUP }) {}

    void OnAfterConfigLoad(bool /*reload*/) override
    {
        LOG_INFO("gv.customs", "[customs] Early bootstrap (schema + tracking)...");
    ...
    void OnStartup() override
    {
        ...
        LOG_INFO("gv.customs", "┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
        LOG_INFO("gv.customs", "┃ Material Bank – Customs SQL Updater ┃");
        LOG_INFO("gv.customs", "┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
